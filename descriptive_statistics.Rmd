...
```
## Plots that are related to Time
...
ggplot(sky_dark_counts, aes(x = Sky_Is_Dark, y = total_incidents, fill = Sky_Is_Dark)) +
  ...
  labs(title = 'Number of Shooting Incidents by the time of a day (Daytime vs. Nigttime)',
...
# Display the table in the desired format
kable(top_10_nta_incident_rate, digits = 6, caption = "Top 10 NTAs with the Highest Incident Rate by Year in Each Borough")
```
...
## Plot Total Number of Incidents Across NYC BOROs (2017-2023)
...
## Plot Total Number of Incidents Across NYC CDTAs from 2017 to 2023
...
"QN80" "SI95" "QN84" are my NAs. There is no shooting incident in these CDTAs. I assigned these 3 CDTA with 0 incident.
...
### CDTA Incidents in each Boroughs from 2017 to 2023
```{r}
