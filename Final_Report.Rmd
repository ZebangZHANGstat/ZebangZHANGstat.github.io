...
* Across all neighborhoods in NYC,there is a negative linear relationship between the percentage of people who graduated from high school (Percent_education) and the incident rate by neighborhood (incident_rate_by_year_nta).(r = -0.2748).
* Associations differ by borough.
